...
\subsection{Application I: PHP-FPM}
The authors integrate light-weight contexts into the PHP-FPM FastCGI server.

\subsection{Application II: Apache \& nginx with OpenSSL}
