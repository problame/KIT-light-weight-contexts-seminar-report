...
By allowing threads to rapidly switch between lwCs, pass arguments, and selectively share resources, compartmentializing requests or code modules becomes possible.\\
...
However, we have found the the performance benchmarks for the modified applications to be incomplete and unprepresentative of real-world work loads.
In particular, the availibility of a tagged TLB seems critical for performance, but neither the design nor the evaluation address the issue of TLB tag exhaustion.
