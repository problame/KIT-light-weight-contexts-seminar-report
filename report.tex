...
\begin{tabular}{|r||c|c|c|}
  ...
  \hline
  new lwC       &    $\bot$    & \multicolumn{2}{c|}{like lwcSwitch}\\
  \hline
\end{tabular}
\caption{
...
resources of the current lwC can be either \textit{copied to}, \textit{unmapped from} or \textit{shared} with the new lwCs.
